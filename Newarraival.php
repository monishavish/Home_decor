    ...
    <div class="slider">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="newB2.png" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="newB1.jpg" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="newB3.png" class="d-block w-100" height="600" alt="...">
        </div>
      </div>
