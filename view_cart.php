...
error_reporting(0);
                    ...
                    while( $row = mysqli_fetch_array($result)) {
                        ...
                        if($row['discount']>0){
                            ...
                            echo "<p style=\"color:black;font-size:20px;background-color:lightgrey;\">Price : ".$price."</p>";
                        }
                        else{
                            echo "<p style=\"color:black;font-size:20px;background-color:lightgrey;\">Price : " .$row['item_price']." .</p>";
                        }
                        echo "<a href=\"http://localhost/Home decor/deleteitem.php?product_id=".$row['product_id']."\"><button type=\"button\" class=\"btn btn-info btn-lg\" style=\"background-color:#63639b;border-color:#63639b\" >Remove</button></a>";
                        echo "</tr>";
                        echo "</td>";
                        echo "</table>";
                    }
                   echo "<p style=\"text-align:center;font-size:30px;\">Total price: ";
                ...
                echo $sum . "</br>";
                echo "<a href=\"http://localhost/Home decor/deleteitem.php?product_id=".$row['product_id']."&user=".$user."\"><button type=\"button\" class=\"btn btn-info btn-lg\" style=\"background-color:#63639b;border-color:#63639b\" >Proceed to pay</button></a>";
                echo "<br>";
