    ...
    <div class="slider">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="disB1.png" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="disB2.png" class="d-block w-100" width="100" height="600" alt="...">
        </div>
      </div>
            ...
            <h2>Discount's</h2>
                ...
                <?php  
                    ...
                    while( $row = mysqli_fetch_array($result)) {
                        if($row['discount'] > 0 && $row['type']=="old"){
                ...
                else if($row['discount']>0 && $row['type']=="new"){
                    echo "<table style=\"display:inline-block;padding-right:25px;padding-bottom:50px;margin-left:125px;\">";
                    echo "<tr>"; 
                    echo "<td>";
                    echo "<div style=\"box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);max-width: 300px;margin: auto;text-align: center;font-family: arial;\">";
