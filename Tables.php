    ...
    <div class="slider">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="tabB1.jpg" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="tabB2.jpg" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="tabB3.jpg" class="d-block w-100" height="600" alt="...">
        </div>
      </div>
            ...
            <h2>Tables</h2>
                ...
                <?php  
                    ...
                    while( $row = mysqli_fetch_array($result)) {
                        ...
                        echo "<br><br>";
                        echo "<p><a href=\"http://localhost/Home%20decor/cart.php?product_id=".$row['product_id']." \"<button style=\" border: none;outline: 0;padding: 12px;color: white;background-color: #000;text-align: center;cursor: pointer;width: 100%;font-size: 18px;\"><i class=\"fa fa-shopping-cart\"></i>  Add to Cart</button></a></p>";
                        echo "</td>";
                        echo "</tr>"; 
                        echo "</table>";
                } 
                else if($row['cat_id']==2 && $row['type']=="new"){
                    echo "<table style=\"display:inline-block;padding-right:25px;padding-bottom:50px;margin-left:125px;\">";
                    echo "<tr>"; 
                    echo "<td>";
                    echo "<div style=\"box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);max-width: 300px;margin: auto;text-align: center;font-family: arial;\">";
