...
echo "<section class=\"header\">";
    echo "<div class=\"side-menu\" id=\"side-menu\">";
        ...
        echo "<li><a href=\"http://localhost/Home%20decor/Combos.php?user=".$user."\">Combo's</a></li>";
        echo "</ul>";
    echo "</div>";
    ?>
    <div class="slider">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="comboB.png" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="comboB2.jpg" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="comboB3.jpg" class="d-block w-100" height="600" alt="...">
        </div>
      </div>
            ...
            <h2>Combo's</h2>
                ...
                <?php  
                    ...
                    while( $row = mysqli_fetch_array($result)) {
                        ...
                        echo "<p style=\"color:black;background-color:lightgrey;font-size:17px;\">COMBOS'SS!!</p>";
