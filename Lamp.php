    ...
    <div class="slider">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="lampB1.jpg" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="lampB2.jpg" class="d-block w-100" height="600" alt="...">
        </div>
        <div class="carousel-item">
          <img src="lampB3.jpg" class="d-block w-100" height="600" alt="...">
        </div>
      </div>
    ...
    <div class="container">
        <div class="title-box"> 
            <h2>Lamps</h2>
                ...
                else if($row['cat_id']==1 && $row['type']=="new"){
                    echo "<table style=\"display:inline-block;padding-right:25px;padding-bottom:50px;margin-left:125px;\">";
                    echo "<tr>"; 
                    echo "<td>";
                    echo "<div style=\"box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);max-width: 300px;margin: auto;text-align: center;font-family: arial;\">";
